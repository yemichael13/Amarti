...
import { getPostImageFiles } from "../../utils/postMedia";
...
const AdminDashboard = () => {
  ...
  const getImageUrls = (files) =>
    getPostImageFiles(files).map((f) => getFileUrl(f.file_path)).filter(Boolean);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.map((post) => {
                const imageUrls = getImageUrls(post.files);
                return (
                            ...
                            <img
                              ...
                              className={
                                imageUrls.length === 1
                                  ...
                                  : "h-48 w-40 shrink-0 object-cover"
                              }
                            />
                          ))}
                        </div>
